...
module.exports = {
    checkContest: (data, res, isStrict) => {
        let cl = [
            ...
            [data.description, `콘테스트 설명을 10 ~ 1000글자 사이로 작성해주세요.`, /^(?=.*).{1,1000}$/m],
            [data.fieldEntry, `접수 방법을 10 ~ 1000글자 사이로 작성해주세요.`, /^(?=.*).{1,1000}$/m],
            [data.criteria, `심사기준을 10 ~ 1000글자 사이로 작성해주세요.`, /^(?=.*).{1,1000}$/m],
            [data.award, `수상 정보를 10 ~ 1000글자 사이로 작성해주세요.`, /^(?=.*).{1,1000}$/m],
